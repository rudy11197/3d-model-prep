...
namespace AssetPipeline
{
    ...
    public class MergeAnimationsProcessor : ModelProcessor
    {
        ...
        // For merging in animations
        // A string of filenames separated by semicolons ';'
        ...
        {
            // == The extra stuff for merging animations ==

            if (!string.IsNullOrEmpty(MergeAnimations))
            {
                // Uses methods from System.Linq
